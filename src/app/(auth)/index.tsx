...
import PerleDesLysWordmark from "@/assets/perledeslys/perle-des-lys-log-with-text.svg";
      ...
      <SafeAreaView className="flex-1" edges={["bottom"]}>
        ...
        <View className="relative aspect-[4/5] w-full">
          ...
          <View className="absolute bottom-4 left-5 flex-row items-center gap-1.5 rounded-full bg-background/95 px-3 py-1.5">
            ...
            <Text className="text-[11px] font-medium text-foreground">Accès cliente uniquement</Text>
          </View>
        </View>

        {/* Content */}
        <View className="flex-1 items-center px-6 pb-6 pt-6">
          <PerleDesLysWordmark width={220} height={207} />
          <Text className="-mt-2 text-base font-medium text-foreground">Par Ghania</Text>
          <Text className="mt-4 text-center text-[14px] leading-relaxed text-muted-foreground">
            Recettes signatures, lives privés et tutoriels exclusifs autour de votre TM7, créés avec
            amour par Ghania - votre conseillère Thermomix
          </Text>
          ...
          <View className="mt-auto w-full gap-3 pt-8">
            ...
            <Link href="/(auth)/login" asChild>
              <Button variant="outline" className="rounded-2xl border-primary/30 bg-card py-4">
                <Text className="font-medium text-foreground/80">Créer un compte</Text>
              </Button>
            </Link>
