...
// Legacy Expo-template tokens — still consumed by the default scaffold
// components (ThemedText, ThemedView, HintRow, use-theme, app-tabs,
// WebBadge, the stock index/explore screens). Restored as-is from the
// pre-shadcn version of this file so those components keep working
// until they're replaced by real PERLEDESLYS screens.
export const Colors = {
  light: {
    text: "#000000",
    background: "#ffffff",
